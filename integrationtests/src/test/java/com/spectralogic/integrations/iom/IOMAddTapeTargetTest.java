/**
 * This test adds a new data persistence rule after PUT. This will trigger IOM jobs.
 */
...
@Tag("iomtest")
public class IOMAddTapeTargetTest {
    private final static Logger LOG = Logger.getLogger( IOMAddTapeTargetTest.class );
    ...
    public void testPutJob() throws IOException, InterruptedException {
        LOG.info("Starting test: IOMAddTapeTargetTest");
        try {
            ...
            for (BulkObject detail: details) {
                assertTrue(!detail.getPhysicalPlacement().getTapes().isEmpty(), "Tape copies should be equal or greater than 1");
            }
