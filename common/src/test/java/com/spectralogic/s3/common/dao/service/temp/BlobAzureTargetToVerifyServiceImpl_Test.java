...
public final class BlobAzureTargetToVerifyServiceImpl_Test 
{
    ...
    public void testVerifyDoesSo()
    {
        ...
        final BlobAzureTargetToVerifyService service =
                dbSupport.getServiceManager().getService( BlobAzureTargetToVerifyService.class );
        final SuspectBlobAzureTargetService suspectService =
                dbSupport.getServiceManager().getService( SuspectBlobAzureTargetService.class );
        ...
        mockDaoDriver.putBlobOnAzureTarget( target1.getId(), b2.getId() );
        mockDaoDriver.putBlobOnAzureTarget( target1.getId(), b3.getId() );
        mockDaoDriver.putBlobOnAzureTarget( target1.getId(), b4.getId() );
        mockDaoDriver.putBlobOnAzureTarget( target1.getId(), b5.getId() );
        mockDaoDriver.putBlobOnAzureTarget( target2.getId(), b5.getId() );
        mockDaoDriver.putBlobOnAzureTarget( target2.getId(), b6.getId() );
        ...
        try
        {
            transaction.getService( SuspectBlobAzureTargetService.class ).delete(
