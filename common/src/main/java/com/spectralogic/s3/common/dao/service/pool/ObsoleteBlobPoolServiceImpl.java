...
final class ObsoleteBlobPoolServiceImpl
        extends BaseObsoleteBlobService< ObsoleteBlobPool, Pool > implements ObsoleteBlobPoolService
{
    ObsoleteBlobPoolServiceImpl()
    {
        super( ObsoleteBlobPool.class, Pool.class, BlobPool.POOL_ID, PersistenceTarget.LAST_VERIFIED );
    }
}
