...
public class SystemFailureRM
{
    public SystemFailureRM( SystemFailure bean, final BeansServiceManager serviceManager )
    {
        m_bean = bean;
        m_whereClause = null;
    ...
    public SystemFailureRM( final UUID requiredId, final BeansServiceManager serviceManager )
    {
        this( Require.beanPropertyEquals( Identifiable.ID, requiredId ), serviceManager );
    }


    SystemFailureRM(final WhereClause whereClause, final BeansServiceManager serviceManager)
    {
        m_bean = null;
    ...
    synchronized public SystemFailureType getType()
    {
        fetchBeanIfNull();
    ...
    private void fetchBeanIfNull()
    {
        if ( null == m_bean )
        {
            m_bean = m_serviceManager.getRetriever( SystemFailure.class ).attain( m_whereClause );
        }
    }


    synchronized public SystemFailure unwrap()
    {
        fetchBeanIfNull();
        return m_bean;
    }
