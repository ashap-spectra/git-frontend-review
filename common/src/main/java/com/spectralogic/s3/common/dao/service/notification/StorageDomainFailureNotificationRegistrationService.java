...
public interface StorageDomainFailureNotificationRegistrationService 
    extends BeansRetriever< StorageDomainFailureNotificationRegistration >, 
            BeanCreator< StorageDomainFailureNotificationRegistration >, 
            BeanUpdater< StorageDomainFailureNotificationRegistration >,
            BeanDeleter
{
    // empty
}
