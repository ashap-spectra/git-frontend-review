...
public interface BucketChangesNotificationRegistrationService
    extends BeansRetriever<BucketChangesNotificationRegistration>,
            BeanCreator<BucketChangesNotificationRegistration>,
            BeanUpdater<BucketChangesNotificationRegistration>,
            BeanDeleter
{
    // empty
}
