...
public interface S3DataReplicationRuleService
    extends BeansRetriever< S3DataReplicationRule >, 
            BeanCreator< S3DataReplicationRule >, 
            BeanUpdater< S3DataReplicationRule >, 
            BeanDeleter
{
    // empty
}
