...
public interface JobCreationFailedNotificationRegistrationService
    extends BeansRetriever< JobCreationFailedNotificationRegistration >, 
            BeanCreator< JobCreationFailedNotificationRegistration >, 
            BeanUpdater< JobCreationFailedNotificationRegistration >,
            BeanDeleter
{
    // empty
}
