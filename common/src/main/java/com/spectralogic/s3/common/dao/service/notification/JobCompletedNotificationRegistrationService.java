...
public interface JobCompletedNotificationRegistrationService
    extends BeansRetriever< JobCompletedNotificationRegistration >, 
            BeanCreator< JobCompletedNotificationRegistration >, 
            BeanUpdater< JobCompletedNotificationRegistration >,
            BeanDeleter
{
    // empty
}
