...
public class DeleteBucketRequestHandler_Test
{
    @Test
    ...
    public void testDeleteSpectraNamespaceBucketAllowedIfDoneAsReplicatedRequest()
    {
        ...
        driver = new MockHttpRequestDriver( 
                ...
                new MockUserAuthorizationStrategy( user.getName() ),
                RequestType.DELETE,
                bucket.getName() ).addHeader( S3HeaderType.REPLICATION_SOURCE_IDENTIFIER, "" );
        driver.run();
        driver.assertHttpResponseCodeEquals( 403 );
    ...
    @Test
    public void testDeleteBucketDelegatesToPlannerResource()
    {
        final MockHttpRequestSupport support = new MockHttpRequestSupport();
