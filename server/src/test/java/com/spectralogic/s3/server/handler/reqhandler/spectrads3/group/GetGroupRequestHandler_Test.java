...
public final class GetGroupRequestHandler_Test 
{
    @Test
    public void testGetGroupReturnsDetailedGroupInformation()
    {
        ...
        final MockHttpRequestDriver driver = new MockHttpRequestDriver( 
                ...
                RequestType.GET, 
                "_rest_/" + RestDomainType.GROUP.toString() + "/" + group1.getName() );
        driver.run();
        ...
        driver.assertResponseToClientDoesNotContain( "mg1" );
        driver.assertResponseToClientDoesNotContain( "group2" );
        driver.assertResponseToClientDoesNotContain( "user2" );
        driver.assertResponseToClientDoesNotContain( "mg2" );
        driver.assertResponseToClientDoesNotContain( "group3" );
        driver.assertResponseToClientDoesNotContain( "user3" );
        driver.assertResponseToClientDoesNotContain( "mg3" );
    }
}
