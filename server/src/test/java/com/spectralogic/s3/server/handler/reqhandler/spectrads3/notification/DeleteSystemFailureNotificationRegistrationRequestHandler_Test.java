...
import com.spectralogic.s3.common.dao.service.notification.SystemFailureNotificationRegistrationService;
...
public final class DeleteSystemFailureNotificationRegistrationRequestHandler_Test 
{
    @Test
    public void testDeleteRegistrationThatExistsDoesSo()
    {
        ...
        final MockHttpRequestDriver driver = new MockHttpRequestDriver( 
                ...
                RequestType.DELETE, 
                "_rest_/"
                    + RestDomainType.SYSTEM_FAILURE_NOTIFICATION_REGISTRATION.toString()
                    + "/a" );
        driver.run();
        ...
        assertEquals(
                ...
                support
                        .getDatabaseSupport()
                        .getServiceManager()
                        .getService( SystemFailureNotificationRegistrationService.class )
                        .getCount(),
