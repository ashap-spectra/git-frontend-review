...
public final class GetObjectCachedNotificationRegistrationsRequestHandler_Test 
{
    @Test
    public void testObjectCachedNotificationRegistrationsReturnsRegistrations()
    {
        ...
        new HttpResponseContentVerifier( driver )
                .verifyNotificationRegistrationNode(
                        "/Data/S3ObjectCachedNotificationRegistration[1]/",
                        registrations.get( 0 ) )
                .verifyNotificationRegistrationNode(
                        "/Data/S3ObjectCachedNotificationRegistration[2]/",
                        registrations.get( 1 ) );
        driver.assertResponseToClientXPathEquals(
                "/Data/S3ObjectCachedNotificationRegistration[1]/JobId",
                jobId.toString() );
        driver.assertResponseToClientXPathEquals(
                "/Data/S3ObjectCachedNotificationRegistration[2]/JobId",
                "" );
    }
}
