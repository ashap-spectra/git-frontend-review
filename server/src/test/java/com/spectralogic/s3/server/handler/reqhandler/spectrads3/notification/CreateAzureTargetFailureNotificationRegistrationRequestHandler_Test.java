...
public final class CreateAzureTargetFailureNotificationRegistrationRequestHandler_Test 
{
    @Test
    public void testCreateAzureTargetFailureNotificationRegistrationCreatesRegistration()
    {
        ...
        assertEquals(
                ...
                dbSupport.getServiceManager().getRetriever(
                        AzureTargetFailureNotificationRegistration.class ).getCount(),
