...
public final class GetDegradedDs3DataReplicationRulesRequestHandler_Test 
{
     @Test
    public void testGetDegradedRulesOnlyReturnsRulesThatHaveDegradation()
    {
        ...
        final Ds3Target target1 = mockDaoDriver.createDs3Target( "sd1" );
        ...
        MockHttpRequestDriver driver = new MockHttpRequestDriver( 
                ...
                RequestType.GET, 
                "_rest_/" + RestDomainType.DEGRADED_DS3_DATA_REPLICATION_RULE );
        driver.run();
