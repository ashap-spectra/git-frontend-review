...
public final class DeallocatePoolRequestHandler_Test 
{
    @Test
    public void testDeallocatePoolCallsDataPlanner()
            throws NoSuchMethodException, SecurityException
    {
        ...
        final MockHttpRequestDriver driver = new MockHttpRequestDriver( 
                ...
                "_rest_/" + RestDomainType.POOL.toString() + "/" + poolId.toString() )
                        .addParameter( "operation", RestOperationType.DEALLOCATE.toString() );
        driver.run();
