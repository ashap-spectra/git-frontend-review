...
public final class GetDegradedAzureDataReplicationRulesRequestHandler_Test 
{
     @Test
    public void testGetDegradedRulesOnlyReturnsRulesThatHaveDegradation()
    {
        ...
        final AzureTarget target1 = mockDaoDriver.createAzureTarget( "sd1" );
        ...
        MockHttpRequestDriver driver = new MockHttpRequestDriver( 
                ...
                RequestType.GET, 
                "_rest_/" + RestDomainType.DEGRADED_AZURE_DATA_REPLICATION_RULE );
        driver.run();
