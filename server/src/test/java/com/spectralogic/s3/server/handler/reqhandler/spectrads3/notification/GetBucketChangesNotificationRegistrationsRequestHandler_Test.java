...
public final class GetBucketChangesNotificationRegistrationsRequestHandler_Test 
{
    @Test
    public void testBucketChangesNotificationRegistrationsReturnsRegistrations()
    {
        ...
        final List< BucketChangesNotificationRegistration > registrations =
        ...
        new HttpResponseContentVerifier( driver )
                .verifyNotificationRegistrationNode(
                        "/Data/BucketChangesNotificationRegistration[1]/",
                        registrations.get( 0 ) )
                .verifyNotificationRegistrationNode(
                        "/Data/BucketChangesNotificationRegistration[2]/",
                        registrations.get( 1 ) );
    }
}
