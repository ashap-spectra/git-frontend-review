...
public final class GetSuspectObjectsRequestHandler_Test
{
     @Test
    public void testGetDoesSoWhenPermitted()
    {
        ...
        final StorageDomainMember tsdm1 = mockDaoDriver.addTapePartitionToStorageDomain(
                sd1.getId(), tape1.getPartitionId(), tape1.getType() );
        final StorageDomainMember tsdm2 = mockDaoDriver.addTapePartitionToStorageDomain(
                sd2.getId(), tape1.getPartitionId(), tape1.getType() );
        final StorageDomainMember psdm1 = mockDaoDriver.addPoolPartitionToStorageDomain(
                sd1.getId(), pool1.getPartitionId() );
        final StorageDomainMember psdm2 = mockDaoDriver.addPoolPartitionToStorageDomain(
                sd2.getId(), pool1.getPartitionId() );
        ...
        driver.assertResponseToClientContains( bucket1.getId().toString() );
        ...
        driver.assertResponseToClientContains( o2.getName() );
        driver.assertResponseToClientDoesNotContain( bucket1.getId().toString() );
        driver.assertResponseToClientContains( bucket2.getId().toString() );
        driver.assertResponseToClientDoesNotContain( tape1.getId().toString() );
        driver.assertResponseToClientDoesNotContain( tape2.getId().toString() );
        driver.assertResponseToClientDoesNotContain( pool1.getId().toString() );
