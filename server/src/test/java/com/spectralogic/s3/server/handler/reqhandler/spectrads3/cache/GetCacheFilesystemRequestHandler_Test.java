...
public final class GetCacheFilesystemRequestHandler_Test 
{
    @Test
    public void testGetCacheFilesystem()
    {
        ...
        final MockHttpRequestDriver driver = new MockHttpRequestDriver( 
                ...
                RequestType.GET, 
                "_rest_/" + RestDomainType.CACHE_FILESYSTEM + "/" + bean.getId().toString() );
        driver.run();
        driver.assertHttpResponseCodeEquals( 200 );
        driver.assertResponseToClientXPathEquals( "/Data/Id", bean.getId().toString() );
    }
}
