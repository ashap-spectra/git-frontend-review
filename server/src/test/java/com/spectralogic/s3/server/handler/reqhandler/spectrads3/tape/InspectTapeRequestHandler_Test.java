...
public final class InspectTapeRequestHandler_Test 
{
    @Test
    public void testtestInspectTapeCallsDataPlanner()
    {
        ...
        assertEquals(expected, inspectTape.getTapeIds(), "Shoulda inspectted only the expected tape id.");
        assertEquals(null, inspectTape.getPriorities().get( 0 ), "Shoulda inspectted only the expected tape id.");
    }
    
    
    @Test
    public void testtestInspectTapeWithTaskPriorityCallsDataPlanner()
    {
        final MockHttpRequestSupport support = new MockHttpRequestSupport();
