...
public final class GetObjectLostNotificationRegistrationRequestHandler_Test 
{
    @Test
    public void testGetObjectLostNotificationRegistrationReturnsNotification()
    {
        ...
        final MockHttpRequestDriver driver = new MockHttpRequestDriver( 
                ...
                RequestType.GET, 
                "_rest_/" + RestDomainType.OBJECT_LOST_NOTIFICATION_REGISTRATION.toString() + "/a" );
        driver.run();
