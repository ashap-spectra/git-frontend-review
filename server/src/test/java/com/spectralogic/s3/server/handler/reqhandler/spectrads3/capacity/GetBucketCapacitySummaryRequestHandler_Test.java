...
public final class GetBucketCapacitySummaryRequestHandler_Test 
{
    @Test
    public void testRequestHandlerDoesNotErr()
    {
        ...
        final DataPolicy dataPolicy = mockDaoDriver.getDataPolicyFor( bucket1.getId() );
        ...
        mockDaoDriver.createDataPersistenceRule( 
                dataPolicy.getId(), DataPersistenceRuleType.values()[ 0 ], sd1.getId() );
        mockDaoDriver.createDataPersistenceRule( 
                DataIsolationLevel.BUCKET_ISOLATED, 
                dataPolicy.getId(), DataPersistenceRuleType.values()[ 0 ], sd2.getId() );
                
        final Tape t1 = BeanFactory.newBean( Tape.class )
                .setState( TapeState.NORMAL )
                .setAvailableRawCapacity( Long.valueOf( 200 ) )
                .setTotalRawCapacity( Long.valueOf( 800 ) )
        ...
        MockHttpRequestDriver driver = new MockHttpRequestDriver( 
            ...
            .addParameter( CapacitySummaryRequiredParams.BUCKET_ID, bucket1.getName() );
        driver.run();
        driver.assertHttpResponseCodeEquals( 200 );
        driver.assertResponseToClientContains( "<PhysicalAllocated>800</PhysicalAllocated>" );
        ...
        driver = new MockHttpRequestDriver( 
            ...
            .addParameter( CapacitySummaryRequiredParams.STORAGE_DOMAIN_ID, sd2.getName() )
            .addParameter( CapacitySummaryRequiredParams.BUCKET_ID, bucket1.getName() )
            .addParameter( CapacitySummaryOptionalParams.TAPE_STATE, TapeState.values()[ 0 ].toString() );
        driver.run();
        driver.assertHttpResponseCodeEquals( 200 );
        driver.assertResponseToClientContains( "<PhysicalAllocated>800</PhysicalAllocated>" );
        ...
        driver = new MockHttpRequestDriver( 
            ...
            .addParameter( CapacitySummaryRequiredParams.STORAGE_DOMAIN_ID, sd2.getName() )
            .addParameter( CapacitySummaryRequiredParams.BUCKET_ID, bucket1.getName() )
            .addParameter( CapacitySummaryOptionalParams.TAPE_STATE, TapeState.values()[ 1 ].toString() );
        driver.run();
        driver.assertHttpResponseCodeEquals( 200 );
        driver.assertResponseToClientContains( "<PhysicalAllocated>0</PhysicalAllocated>" );

        mockDaoDriver.updateAllBeans( 
                BeanFactory.newBean( DataPersistenceRule.class )
                .setIsolationLevel( DataIsolationLevel.STANDARD ), DataPersistenceRule.ISOLATION_LEVEL );
        driver = new MockHttpRequestDriver( 
                support,
                true,
                new MockInternalRequestAuthorizationStrategy(),
        ...
        driver.run();
        driver.assertHttpResponseCodeEquals( 200 );
        driver.assertResponseToClientContains( "<PhysicalAllocated>2</PhysicalAllocated>" );
    }
}
