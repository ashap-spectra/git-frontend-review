...
public final class OnlineTapeRequestHandler_Test 
{
    @Test
    public void testtestOnlineTapeCallsDataPlanner()
            throws NoSuchMethodException, SecurityException
    {
        ...
        assertEquals(expected, ih.getTapeIds(), "Shoulda sent only the expected tape id.");
    }
}
