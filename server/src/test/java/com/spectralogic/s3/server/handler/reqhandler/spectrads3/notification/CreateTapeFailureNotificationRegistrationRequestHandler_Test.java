...
public final class CreateTapeFailureNotificationRegistrationRequestHandler_Test 
{
    @Test
    public void testCreateTapeFailureNotificationRegistrationCreatesRegistration()
    {
        ...
        assertEquals(
                ...
                dbSupport.getServiceManager().getRetriever(
                        TapeFailureNotificationRegistration.class ).getCount(),
