...
public final class GetTapePartitionsWithFullDetailsRequestHandler_Test 
{
    @Test
    public void testtestGetTapePartitionsWithFullDetailsReturnsTapePartitions()
    {
        ...
        final MockHttpRequestDriver driver = new MockHttpRequestDriver( 
                ...
                RequestType.GET, 
                "_rest_/tape_partition" ).addParameter( RequestParameterType.FULL_DETAILS.toString(), "" );
        driver.run();
        ...
        driver.assertResponseToClientContains( TapeType.TS_JC.toString() );
    }
}
