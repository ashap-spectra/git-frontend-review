...
public final class DeleteS3DataReplicationRuleRequestHandler_Test 
{
    @Test
    public void testDeleteDelegatesToDataPlanner()
    {
        ...
        final MockHttpRequestDriver driver = new MockHttpRequestDriver(
                ...
                RequestType.DELETE, 
                "_rest_/" + RestDomainType.S3_DATA_REPLICATION_RULE + "/" + rule.getId().toString() );
        driver.run();
        driver.assertHttpResponseCodeEquals( 204 );
        
        support.getDatabaseSupport().getServiceManager().getRetriever( S3DataReplicationRule.class ).attain(
                Require.nothing() );
        assertEquals(
                1,
