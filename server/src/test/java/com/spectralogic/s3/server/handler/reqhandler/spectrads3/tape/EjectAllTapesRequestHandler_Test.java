...
public final class EjectAllTapesRequestHandler_Test 
{
    @Test
    public void testtestEjectAllTapesCallsDataPlanner()
    {
        ...
        assertEquals(1,  btih.getMethodCallCount(method), "Shoulda called the cancel with null exactly once.");
        assertEquals(null, btih.getMethodInvokeData( method ).get( 0 ).getArgs().get( 0 ), "Shoulda called the cancel with null exactly once.");
    ...
    @Test
    public void testtestEjectAllTapesAllOptionalAttributesSpecifiedCallsDataPlanner()
    {
        final MockHttpRequestSupport support = new MockHttpRequestSupport();
