...
public final class GetCacheStateRequestHandler_Test 
{
    @Test
    public void testGetDataPlannerCacheState()
    {
        ...
        assertXPath( driver, "JobLockedCacheInBytes", "1234" );
    ...
    private final class GetCacheStateInvocationHandler implements InvocationHandler
    {
                ...
                throws Throwable
        {
            ...
            cacheFilesystemInformation.setJobLockedCacheInBytes( 1234L );
