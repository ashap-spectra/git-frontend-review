...
public final class CancelEjectTapeRequestHandler_Test 
{
    @Test
    public void testtestCancelEjectTapeRequestHandlerCallsDataPlanner()
            throws NoSuchMethodException, SecurityException
    {
        ...
        final MediaOperationInvocationHandler cancelEjectTape = new MediaOperationInvocationHandler();
        support.setTapeInterfaceIh(
                MockInvocationHandler.forMethod(
                        TapeManagementResource.class.getMethod( "cancelEjectTape", UUID.class ),
                        cancelEjectTape,
                        null ) );
        ...
        final MockHttpRequestDriver driver = new MockHttpRequestDriver( 
                ...
                "_rest_/tape/" + tapeId.toString() )
                        .addParameter( "operation", RestOperationType.CANCEL_EJECT.toString() );
        driver.run();
        driver.assertHttpResponseCodeEquals( 200 );
        
        assertEquals(
                CollectionFactory.toList( tapeId ),
                cancelEjectTape.getTapeIds(),
