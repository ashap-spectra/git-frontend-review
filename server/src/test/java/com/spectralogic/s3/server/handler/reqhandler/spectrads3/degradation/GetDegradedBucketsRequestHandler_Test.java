...
public final class GetDegradedBucketsRequestHandler_Test 
{
     @Test
    public void testGetDegradedBucketsOnlyReturnsBucketsThatHaveDegradationThatUserAllowedToSee()
    {
        ...
        driver = new MockHttpRequestDriver( 
                ...
                new MockUserAuthorizationStrategy( "barry" ),
                RequestType.GET, 
                "_rest_/" + RestDomainType.DEGRADED_BUCKET ).addParameter( Bucket.NAME, "%barry%" );
        driver.run();
        driver.assertHttpResponseCodeEquals( 200 );
        driver.assertResponseToClientDoesNotContain( "bucketjason" );
        driver.assertResponseToClientContains( "bucketbarry" );
