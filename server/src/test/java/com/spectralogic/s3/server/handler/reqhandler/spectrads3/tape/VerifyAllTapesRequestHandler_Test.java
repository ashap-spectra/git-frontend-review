...
public final class VerifyAllTapesRequestHandler_Test 
{
    @Test
    public void testtestVerifyAllTapesCallsDataPlanner()
    {
        ...
        assertEquals(expected1, verifyTape.getTapeIds(), "Shoulda passed null into Verify tape exactly once.");
        assertEquals(null, verifyTape.getPriorities().get( 0 ), "Shoulda verifyted only the expected tape id.");

        verifyTape.clear();
        verifyTape.addTapeFailure( UUID.randomUUID(), "oops" );
        ...
        assertEquals(expected, verifyTape.getTapeIds(), "Shoulda passed null into Verify tape exactly once.");
        assertEquals(null, verifyTape.getPriorities().get( 0 ), "Shoulda verifyted only the expected tape id.");
    }
    
    
    @Test
    public void testtestVerifyAllTapesWithPriorityCallsDataPlanner()
    {
        final MockHttpRequestSupport support = new MockHttpRequestSupport();
