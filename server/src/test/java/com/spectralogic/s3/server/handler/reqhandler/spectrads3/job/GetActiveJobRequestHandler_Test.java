...
public final class GetActiveJobRequestHandler_Test 
{
    @Test
    public void testGetDoesSoWhenUserHasAccess()
    {
        ...
        MockHttpRequestDriver driver = new MockHttpRequestDriver( 
                ...
                RequestType.GET, 
                "_rest_/" + RestDomainType.ACTIVE_JOB + "/" + jobId1 );
        driver.run();
        ...
        driver = new MockHttpRequestDriver( 
                ...
                new MockUserAuthorizationStrategy( MockDaoDriver.DEFAULT_USER_NAME ),
                RequestType.GET, 
                "_rest_/" + RestDomainType.ACTIVE_JOB + "/" + jobId2 );
        driver.run();
        ...
        driver = new MockHttpRequestDriver( 
                ...
                new MockUserAuthorizationStrategy( MockDaoDriver.DEFAULT_USER_NAME ),
                RequestType.GET, 
                "_rest_/" + RestDomainType.ACTIVE_JOB + "/" + jobId3 );
        driver.run();
        driver.assertHttpResponseCodeEquals( 200 );
    }
}
