...
import com.spectralogic.s3.common.dao.service.notification.S3ObjectLostNotificationRegistrationService;
...
public final class DeleteObjectLostNotificationRegistrationRequestHandler_Test 
{
    @Test
    public void testDeleteRegistrationThatExistsDoesSo()
    {
        ...
        final S3ObjectLostNotificationRegistrationService service = 
                dbSupport.getServiceManager().getService(
                        S3ObjectLostNotificationRegistrationService.class );
        service.create(
                BeanFactory.newBean( S3ObjectLostNotificationRegistration.class )
        ...
        final MockHttpRequestDriver driver = new MockHttpRequestDriver( 
                ...
                RequestType.DELETE, 
                "_rest_/" + RestDomainType.OBJECT_LOST_NOTIFICATION_REGISTRATION.toString() + "/" 
