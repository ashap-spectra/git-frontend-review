...
public final class ClearSuspectBlobDs3TargetsRequestHandler_Test
{
    @Test
    public void testClearAllDoesSoIfForceFlagUsed()
    {
        ...
        final StorageDomainMember sdm1 = mockDaoDriver.addTapePartitionToStorageDomain( 
                sd.getId(), tape1.getPartitionId(), TapeType.LTO5 );
        ...
        MockHttpRequestDriver driver = new MockHttpRequestDriver( 
                ...
                RequestType.DELETE, 
                "_rest_/" + RestDomainType.SUSPECT_BLOB_DS3_TARGET );
        driver.run();
    ...
    public void testClearSpecificIdsDoesSo() throws UnsupportedEncodingException
    {
        ...
        final BlobDs3Target bTarget = mockDaoDriver.makeSuspect( 
                mockDaoDriver.putBlobOnDs3Target( target1.getId(), blobObj1.getId() ) );
        ...
        mockDaoDriver.makeSuspect( mockDaoDriver.putBlobOnDs3Target( target2.getId(), blobObj1.getId() ) );
        ...
        assertEquals(1,  support.getDatabaseSupport().getServiceManager().getRetriever(
                SuspectBlobDs3Target.class).getCount(), "Shoulda deleted specified suspect records of the appropriate type.");
        assertEquals(0,  support.getDatabaseSupport().getServiceManager().getRetriever(
                DegradedBlob.class).getCount(), "Should notta recorded any degradation.");
    }
