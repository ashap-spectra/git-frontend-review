...
public final class GetTapeDensityDirectiveRequestHandler_Test 
{
    @Test
    public void testtestGetDoesSo()
    {
        ...
        final MockHttpRequestDriver driver = new MockHttpRequestDriver( 
                ...
                RequestType.GET, 
                "_rest_/" + RestDomainType.TAPE_DENSITY_DIRECTIVE + "/" + directive1.getId() );
        driver.run();
        driver.assertHttpResponseCodeEquals( 200 );
        driver.assertResponseToClientContains( directive1.getPartitionId().toString() );
        driver.assertResponseToClientDoesNotContain( directive2.getPartitionId().toString() );
    }
}
