...
public final class CreateGroupGroupMemberRequestHandler_Test 
{
    @Test
    ...
    public void testCreateOnEveryoneGroupNotAllowed()
    {
        ...
        final Group memberGroup = mockDaoDriver.createGroup( "mg" );
        ...
        final MockHttpRequestDriver driver = new MockHttpRequestDriver( 
            ...
            .addParameter( GroupMember.MEMBER_GROUP_ID, memberGroup.getName() );
        driver.run();
    ...
    @Test
    public void testCreateThatWouldResultInValidationFailureDoesNotModifyDao()
    {
        final MockHttpRequestSupport support = new MockHttpRequestSupport();
        ...
        final MockHttpRequestDriver driver = new MockHttpRequestDriver( 
                ...
                "_rest_/" + RestDomainType.GROUP_MEMBER.toString() )
            .addParameter( GroupMember.GROUP_ID, group.getName() )
            .addParameter( GroupMember.MEMBER_GROUP_ID, group.getName() );
        driver.run();
