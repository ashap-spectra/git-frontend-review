...
import com.spectralogic.s3.common.dao.service.notification.AzureTargetFailureNotificationRegistrationService;
...
public final class DeleteAzureTargetFailureNotificationRegistrationRequestHandler_Test 
{
    @Test
    public void testDeleteRegistrationThatExistsDoesSo()
    {
        ...
        final MockHttpRequestDriver driver = new MockHttpRequestDriver( 
                ...
                RequestType.DELETE, 
                "_rest_/" + RestDomainType.AZURE_TARGET_FAILURE_NOTIFICATION_REGISTRATION.toString() + "/a" );
        driver.run();
        ...
        assertEquals(
                ...
                support
                        .getDatabaseSupport()
                        .getServiceManager()
                        .getService( AzureTargetFailureNotificationRegistrationService.class )
                        .getCount(),
