...
import com.spectralogic.s3.common.dao.service.notification.StorageDomainFailureNotificationRegistrationService;
...
public final class DeleteStorageDomainFailureNotificationRegistrationRequestHandler_Test 
{
    @Test
    public void testDeleteRegistrationThatExistsDoesSo()
    {
        ...
        final MockHttpRequestDriver driver = new MockHttpRequestDriver( 
                ...
                RequestType.DELETE, 
                "_rest_/"
                    + RestDomainType.STORAGE_DOMAIN_FAILURE_NOTIFICATION_REGISTRATION.toString()
                    + "/a" );
        driver.run();
        ...
        assertEquals(
                ...
                support
                        .getDatabaseSupport()
                        .getServiceManager()
                        .getService( StorageDomainFailureNotificationRegistrationService.class )
                        .getCount(),
