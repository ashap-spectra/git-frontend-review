...
public final class GetDegradedBlobsRequestHandler_Test 
{
     @Test
    public void testGetDoesSo()
    {
        ...
        MockHttpRequestDriver driver = new MockHttpRequestDriver( 
                ...
                RequestType.GET, 
                "_rest_/" + RestDomainType.DEGRADED_BLOB );
        driver.run();
        driver.assertHttpResponseCodeEquals( 200 );
        driver.assertResponseToClientDoesNotContain( bucketJasonId.toString() );
        driver.assertResponseToClientDoesNotContain( bucketBarryId.toString() );
        ...
        driver.run();
        driver.assertHttpResponseCodeEquals( 200 );
        driver.assertResponseToClientContains( bucketJasonId.toString() );
        driver.assertResponseToClientDoesNotContain( bucketBarryId.toString() );
        ...
        driver.assertHttpResponseCodeEquals( 200 );
        driver.assertResponseToClientContains( bucketJasonId.toString() );
        driver.assertResponseToClientContains( bucketBarryId.toString() );
        ...
        driver = new MockHttpRequestDriver( 
                ...
                RequestType.GET, 
                "_rest_/" + RestDomainType.DEGRADED_BLOB ).addParameter( 
                        BlobObservable.BLOB_ID, barryBlob.getId().toString() );
        driver.run();
        driver.assertHttpResponseCodeEquals( 200 );
        driver.assertResponseToClientDoesNotContain( bucketJasonId.toString() );
        driver.assertResponseToClientContains( bucketBarryId.toString() );
