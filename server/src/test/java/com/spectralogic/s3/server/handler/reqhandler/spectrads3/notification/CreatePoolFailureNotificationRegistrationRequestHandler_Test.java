...
public final class CreatePoolFailureNotificationRegistrationRequestHandler_Test 
{
    @Test
    public void testCreatePoolFailureNotificationRegistrationCreatesRegistration()
    {
        ...
        assertEquals(
                ...
                dbSupport.getServiceManager().getRetriever(
                        PoolFailureNotificationRegistration.class ).getCount(),
