...
public final class GetSystemFailureNotificationRegistrationsRequestHandler_Test 
{
    @Test
    public void testGetObjectPersistedNotificationRegistrationsReturnsRegistrations()
    {
        ...
        new HttpResponseContentVerifier( driver )
                .verifyNotificationRegistrationNode(
                        "/Data/SystemFailureNotificationRegistration[1]/",
                        registrations.get( 0 ) )
                .verifyNotificationRegistrationNode(
                        "/Data/SystemFailureNotificationRegistration[2]/",
                        registrations.get( 1 ) );
    }
}
