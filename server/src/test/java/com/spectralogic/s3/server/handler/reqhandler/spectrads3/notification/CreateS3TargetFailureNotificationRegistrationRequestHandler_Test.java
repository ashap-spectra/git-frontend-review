...
public final class CreateS3TargetFailureNotificationRegistrationRequestHandler_Test 
{
    @Test
    public void testCreateS3TargetFailureNotificationRegistrationCreatesRegistration()
    {
        ...
        assertEquals(
                ...
                dbSupport.getServiceManager().getRetriever(
                        S3TargetFailureNotificationRegistration.class ).getCount(),
