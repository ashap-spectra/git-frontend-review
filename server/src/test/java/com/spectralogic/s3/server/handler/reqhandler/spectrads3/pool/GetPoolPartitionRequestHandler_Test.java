...
public final class GetPoolPartitionRequestHandler_Test 
{
    @Test
    public void testGetDoesSo()
    {
        ...
        final MockHttpRequestDriver driver = new MockHttpRequestDriver(
                ...
                RequestType.GET, 
                "_rest_/" + RestDomainType.POOL_PARTITION + "/" + partition.getId().toString() );
        driver.run();
        driver.assertHttpResponseCodeEquals( 200 );
        driver.assertResponseToClientContains( partition.getId().toString() );
        driver.assertResponseToClientDoesNotContain( partition2.getId().toString() );
    }
}
