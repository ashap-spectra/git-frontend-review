...
public final class CompactAllPoolsRequestHandler_Test 
{
    @Test
    public void testCompactAllPoolsCallsDataPlanner()
    {
        ...
        support.setPoolInterfaceIh(
                MockInvocationHandler.forMethod(
                        ReflectUtil.getMethod( PoolManagementResource.class, "compactPool" ),
                        inspectPool,
                        null ) );
    ...
    @Test
    public void testCompactAllPoolsWithPriorityCallsDataPlanner()
    {
        final MockHttpRequestSupport support = new MockHttpRequestSupport();
