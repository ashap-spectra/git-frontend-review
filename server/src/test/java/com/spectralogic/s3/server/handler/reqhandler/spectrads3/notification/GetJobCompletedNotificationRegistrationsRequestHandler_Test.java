...
public final class GetJobCompletedNotificationRegistrationsRequestHandler_Test 
{
    @Test
    public void testGetJobCompletedNotificationRegistrationsReturnsRegistrations()
    {
        ...
        final List< JobCompletedNotificationRegistration > registrations =
        ...
        new HttpResponseContentVerifier( driver )
                .verifyNotificationRegistrationNode(
                        "/Data/JobCompletedNotificationRegistration[1]/",
                        registrations.get( 0 ) )
                .verifyNotificationRegistrationNode(
                        "/Data/JobCompletedNotificationRegistration[2]/",
                        registrations.get( 1 ) );
        driver.assertResponseToClientXPathEquals(
                "/Data/JobCompletedNotificationRegistration[1]/JobId",
                jobId.toString() );
        driver.assertResponseToClientXPathEquals(
                "/Data/JobCompletedNotificationRegistration[2]/JobId",
                "" );
    }
}
