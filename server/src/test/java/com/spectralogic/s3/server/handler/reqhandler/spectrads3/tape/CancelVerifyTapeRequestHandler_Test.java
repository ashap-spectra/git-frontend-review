...
public final class CancelVerifyTapeRequestHandler_Test 
{
    @Test
    public void testtestCancelVerifyTapeRequestHandlerCallsDataPlanner()
            throws NoSuchMethodException, SecurityException
    {
        ...
        final MediaOperationInvocationHandler cancelVerifyTape = new MediaOperationInvocationHandler();
