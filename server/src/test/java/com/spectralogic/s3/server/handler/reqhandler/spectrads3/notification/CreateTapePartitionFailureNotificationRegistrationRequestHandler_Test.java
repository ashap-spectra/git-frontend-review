...
public final class CreateTapePartitionFailureNotificationRegistrationRequestHandler_Test 
{
    @Test
    public void testCreateTapePartitionFailureNotificationRegistrationCreatesRegistration()
    {
        ...
        assertEquals(
                ...
                dbSupport.getServiceManager().getRetriever(
                        TapePartitionFailureNotificationRegistration.class ).getCount(),
