...
public final class CancelOnlineTapeRequestHandler_Test 
{
    @Test
    public void testtestCancelOnlineTapeRequestHandlerCallsDataPlanner()
            throws NoSuchMethodException, SecurityException
    {
        ...
        final MediaOperationInvocationHandler cancelOnlineTape = new MediaOperationInvocationHandler();
        support.setTapeInterfaceIh(
                MockInvocationHandler.forMethod(
                        TapeManagementResource.class.getMethod( "cancelOnlineTape", UUID.class ),
                        cancelOnlineTape,
                        null ) );
        ...
        final MockHttpRequestDriver driver = new MockHttpRequestDriver( 
                ...
                "_rest_/tape/" + tapeId.toString() )
                        .addParameter( "operation", RestOperationType.CANCEL_ONLINE.toString() );
        driver.run();
        driver.assertHttpResponseCodeEquals( 200 );
        
        assertEquals(
                CollectionFactory.toList( tapeId ),
                cancelOnlineTape.getTapeIds(),
