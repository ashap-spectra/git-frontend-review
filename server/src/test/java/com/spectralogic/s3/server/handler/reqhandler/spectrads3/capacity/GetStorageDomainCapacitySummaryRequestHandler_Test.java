...
public final class GetStorageDomainCapacitySummaryRequestHandler_Test 
{
    @Test
    public void testRequestHandlerDoesNotErr()
    {
        ...
        final PoolPartition poolPartition = 
                mockDaoDriver.createPoolPartition( PoolType.values()[ 0 ], "pp1" );
        ...
        final StorageDomainMember psdm = mockDaoDriver.addPoolPartitionToStorageDomain(
                sd2.getId(), poolPartition.getId() );
        final StorageDomainMember tsdm1 = mockDaoDriver.addTapePartitionToStorageDomain(
                sd1.getId(), partition.getId(), TapeType.values()[ 0 ] );
        final StorageDomainMember tsdm2 = mockDaoDriver.addTapePartitionToStorageDomain(
        ...
        final Pool p1 = BeanFactory.newBean( Pool.class )
                ...
                .setStorageDomainMemberId( psdm.getId() )
                .setAssignedToStorageDomain( true )
                .setGuid( "guid" )
                .setHealth( PoolHealth.values()[ 0 ] )
                .setMountpoint( "mp" )
                .setName( "name" )
                .setPartitionId( poolPartition.getId() );
        ...
        final Tape t2 = BeanFactory.newBean( Tape.class )
                ...
                .setStorageDomainMemberId( tsdm1.getId() )
                .setAssignedToStorageDomain( true )
        ...
        final Tape t3 = BeanFactory.newBean( Tape.class )
                ...
                .setStorageDomainMemberId( tsdm2.getId() )
                .setAssignedToStorageDomain( true )
                .setPartitionId( partition.getId() );
        ...
        MockHttpRequestDriver driver = new MockHttpRequestDriver( 
            ...
            .addParameter( CapacitySummaryRequiredParams.STORAGE_DOMAIN_ID, sd2.getName() );
        driver.run();
        driver.assertHttpResponseCodeEquals( 200 );
        driver.assertResponseToClientContains( "<Tape><PhysicalAllocated>1502</PhysicalAllocated>" );
        driver.assertResponseToClientContains( "<Pool><PhysicalAllocated>1500</PhysicalAllocated>" );
        ...
        driver = new MockHttpRequestDriver( 
                ...
                "_rest_/" + RestDomainType.CAPACITY_SUMMARY )
            .addParameter( CapacitySummaryRequiredParams.STORAGE_DOMAIN_ID, sd2.getName() )
            .addParameter( CapacitySummaryOptionalParams.POOL_TYPE, PoolType.values()[ 0 ].toString() );
        driver.run();
        driver.assertHttpResponseCodeEquals( 200 );
        driver.assertResponseToClientContains( "<Tape><PhysicalAllocated>1502</PhysicalAllocated>" );
        driver.assertResponseToClientContains( "<Pool><PhysicalAllocated>1500</PhysicalAllocated>" );
        ...
        driver = new MockHttpRequestDriver( 
                ...
                "_rest_/" + RestDomainType.CAPACITY_SUMMARY )
            .addParameter( CapacitySummaryRequiredParams.STORAGE_DOMAIN_ID, sd2.getName() )
            .addParameter( CapacitySummaryOptionalParams.POOL_TYPE, PoolType.values()[ 1 ].toString() );
        driver.run();
        driver.assertHttpResponseCodeEquals( 200 );
        driver.assertResponseToClientContains( "<Tape><PhysicalAllocated>1502</PhysicalAllocated>" );
        driver.assertResponseToClientContains( "<Pool><PhysicalAllocated>0</PhysicalAllocated>" );
        ...
        driver = new MockHttpRequestDriver( 
            ...
            .addParameter( CapacitySummaryOptionalParams.POOL_TYPE, PoolType.values()[ 0 ].toString() )
            .addParameter( CapacitySummaryOptionalParams.POOL_STATE, PoolState.NORMAL.toString() )
            .addParameter( CapacitySummaryOptionalParams.POOL_HEALTH, PoolHealth.values()[ 0 ].toString() );
        driver.run();
        driver.assertHttpResponseCodeEquals( 200 );
        driver.assertResponseToClientContains( "<Tape><PhysicalAllocated>1500</PhysicalAllocated>" );
        driver.assertResponseToClientContains( "<Pool><PhysicalAllocated>1500</PhysicalAllocated>" );
    }
}
