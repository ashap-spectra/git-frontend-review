...
public final class GetBucketChangesNotificationRegistrationRequestHandler_Test 
{
    @Test
    public void testBucketChangesNotificationRegistrationByEndPoint()
    {
        ...
        final MockHttpRequestDriver driver = new MockHttpRequestDriver( 
                ...
                RequestType.GET, 
                "_rest_/" + RestDomainType.BUCKET_CHANGES_NOTIFICATION_REGISTRATION.toString() + "/a" );
        driver.run();
