...
public final class DeleteTapeFailureRequestHandler_Test 
{
    @Test
    public void testtestDeleteDoesSo()
    {
        ...
        final TapeFailure failureToDelete = BeanFactory.newBean( TapeFailure.class )
                .setErrorMessage( "AAA" )
        ...
        driver = new MockHttpRequestDriver( 
                ...
                new MockInternalRequestAuthorizationStrategy(),
                RequestType.DELETE, 
                "_rest_/tape_failure/" + failureToDelete.getId() );
        driver.run();
        driver = new MockHttpRequestDriver( 
                support,
                true,
