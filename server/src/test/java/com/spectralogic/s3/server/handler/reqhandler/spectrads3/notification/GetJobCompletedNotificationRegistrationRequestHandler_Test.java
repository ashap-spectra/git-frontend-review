...
public final class GetJobCompletedNotificationRegistrationRequestHandler_Test 
{
    @Test
    public void testGetJobCompletedNotificationRegistrationByEndPoint()
    {
        ...
        final MockHttpRequestDriver driver = new MockHttpRequestDriver( 
                ...
                RequestType.GET, 
                "_rest_/" + RestDomainType.JOB_COMPLETED_NOTIFICATION_REGISTRATION.toString() + "/a" );
        driver.run();
