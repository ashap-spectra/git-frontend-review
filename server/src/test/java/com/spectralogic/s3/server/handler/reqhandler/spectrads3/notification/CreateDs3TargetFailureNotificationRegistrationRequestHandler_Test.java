...
public final class CreateDs3TargetFailureNotificationRegistrationRequestHandler_Test 
{
    @Test
    public void testCreateDs3TargetFailureNotificationRegistrationCreatesRegistration()
    {
        ...
        assertEquals(
                ...
                dbSupport.getServiceManager().getRetriever(
                        Ds3TargetFailureNotificationRegistration.class ).getCount(),
