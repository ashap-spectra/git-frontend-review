...
public final class CancelImportPoolRequestHandler extends BaseRequestHandler
{
    public CancelImportPoolRequestHandler()
    {
            ...
            final CommandExecutionParams params )
    {
        ...
        params.getPoolResource().cancelImportPool( pool.getId() ).get( Timeout.LONG );
