...
public final class CleanTapeDriveRequestHandler extends BaseRequestHandler
{
    public CleanTapeDriveRequestHandler()
    {
        super( new DefaultPublicExposureAuthenticationStrategy( RequiredAuthentication.TAPE_ADMIN ),
               new RestfulCanHandleRequestDeterminer(
                       RestOperationType.CLEAN,
            ...
            final CommandExecutionParams params )
    {
        ...
        params.getTapeResource().cleanDrive( drive.getId() ).get( Timeout.LONG );
