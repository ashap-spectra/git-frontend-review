...
public final class CreateUserGroupMemberRequestHandler extends BaseCreateBeanRequestHandler< GroupMember >
{
    public CreateUserGroupMemberRequestHandler()
    {
    ...
    @Override
    protected UUID createBean( final CommandExecutionParams params, GroupMember bean )
    {
