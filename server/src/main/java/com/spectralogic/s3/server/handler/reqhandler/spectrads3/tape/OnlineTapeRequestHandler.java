...
public final class OnlineTapeRequestHandler extends BaseRequestHandler
{
    public OnlineTapeRequestHandler()
    {
            ...
            final CommandExecutionParams params )
    {
        ...
        params.getTapeResource().onlineTape( tape.getId() ).get( Timeout.LONG );
