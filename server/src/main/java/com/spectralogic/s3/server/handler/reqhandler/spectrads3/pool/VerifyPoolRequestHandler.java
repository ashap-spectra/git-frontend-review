...
public final class VerifyPoolRequestHandler extends BaseDaoTypedRequestHandler< BlobStoreTaskInformation >
{
    public VerifyPoolRequestHandler()
    {
            ...
            final CommandExecutionParams params )
    {
        ...
        params.getPoolResource().verifyPool( pool.getId(), priority.getPriority() ).get( Timeout.LONG );
