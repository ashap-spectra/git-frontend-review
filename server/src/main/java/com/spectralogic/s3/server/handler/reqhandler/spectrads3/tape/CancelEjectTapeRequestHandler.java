...
public final class CancelEjectTapeRequestHandler extends BaseRequestHandler
{
    public CancelEjectTapeRequestHandler()
    {
            ...
            final CommandExecutionParams params )
    {
        ...
        params.getTapeResource().cancelEjectTape( tape.getId() ).get( Timeout.LONG );
