...
public final class EjectTapeRequestHandler extends BaseDaoTypedRequestHandler< Tape >
{
    public EjectTapeRequestHandler()
    {
        super( Tape.class,
        ...
        registerOptionalBeanProperties( Tape.EJECT_LABEL, Tape.EJECT_LOCATION );
    }
