...
public final class CancelVerifyOnAllTapesRequestHandler extends BaseRequestHandler
{
    public CancelVerifyOnAllTapesRequestHandler()
    {
            ...
            final CommandExecutionParams params )
    {
        final TapeFailuresInformation rpcResponse = 
                params.getTapeResource().cancelVerifyTape( null ).get( Timeout.LONG );
