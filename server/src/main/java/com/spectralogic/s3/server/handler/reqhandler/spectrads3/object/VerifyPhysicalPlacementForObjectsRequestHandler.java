...
public final class VerifyPhysicalPlacementForObjectsRequestHandler extends BaseDaoTypedRequestHandler< Tape >
{
    public VerifyPhysicalPlacementForObjectsRequestHandler()
    {
        super( Tape.class,
