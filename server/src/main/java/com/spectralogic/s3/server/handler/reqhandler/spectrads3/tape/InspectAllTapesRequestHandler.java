...
public final class InspectAllTapesRequestHandler extends BaseRequestHandler
{
    public InspectAllTapesRequestHandler()
    {
            ...
            final CommandExecutionParams params )
    {
        ...
        final TapeFailuresInformation rpcResponse =
                params.getTapeResource().inspectTape( null, taskPriority ).get( Timeout.LONG );
