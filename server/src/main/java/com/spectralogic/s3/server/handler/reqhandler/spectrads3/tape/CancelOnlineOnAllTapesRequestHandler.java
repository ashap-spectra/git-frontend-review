...
public final class CancelOnlineOnAllTapesRequestHandler extends BaseRequestHandler
{
    public CancelOnlineOnAllTapesRequestHandler()
    {
            ...
            final CommandExecutionParams params )
    {
        final TapeFailuresInformation rpcResponse = 
                params.getTapeResource().cancelOnlineTape( null ).get( Timeout.LONG );
