...
public final class CancelVerifyPoolRequestHandler extends BaseRequestHandler
{
    public CancelVerifyPoolRequestHandler()
    {
            ...
            final CommandExecutionParams params )
    {
        ...
        params.getPoolResource().cancelVerifyPool( pool.getId() ).get( Timeout.LONG );
