...
public final class DeleteGroupRequestHandler extends BaseDeleteBeanRequestHandler< Group >
{
    ...
    @Override
    protected void deleteBean( final CommandExecutionParams params, final Group group )
    {
        if ( group.isBuiltIn() )
        {
