...
public final class CancelImportOnAllPoolsRequestHandler extends BaseRequestHandler
{
    public CancelImportOnAllPoolsRequestHandler()
    {
    ...
    {
        params.getPoolResource().cancelImportPool( null ).get( Timeout.LONG );
