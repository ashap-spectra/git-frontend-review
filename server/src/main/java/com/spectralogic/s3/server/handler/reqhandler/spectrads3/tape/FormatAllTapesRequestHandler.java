...
public final class FormatAllTapesRequestHandler extends BaseRequestHandler
{
    public FormatAllTapesRequestHandler()
    {
    ...
    {
        final TapeFailuresInformation rpcResponse = params.getTapeResource().formatTape(
                null, 
