...
public final class CancelImportOnAllTapesRequestHandler extends BaseRequestHandler
{
    public CancelImportOnAllTapesRequestHandler()
    {
            ...
            final CommandExecutionParams params )
    {
        final TapeFailuresInformation rpcResponse = 
                params.getTapeResource().cancelImportTape( null ).get( Timeout.LONG );
