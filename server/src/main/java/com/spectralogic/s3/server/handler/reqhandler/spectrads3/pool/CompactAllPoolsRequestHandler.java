...
public final class CompactAllPoolsRequestHandler 
    extends BaseDaoTypedRequestHandler< BlobStoreTaskInformation >
{
    public CompactAllPoolsRequestHandler()
    {
    ...
    {
        final BlobStoreTask priority = getBeanSpecifiedViaQueryParameters(
                params, AutoPopulatePropertiesWithDefaults.YES );
        params.getPoolResource().compactPool( null, priority.getPriority() ).get( Timeout.LONG );
