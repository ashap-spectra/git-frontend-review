...
public final class CancelFormatTapeRequestHandler extends BaseRequestHandler
{
    public CancelFormatTapeRequestHandler()
    {
            ...
            final CommandExecutionParams params )
    {
        ...
        params.getTapeResource().cancelFormatTape( tape.getId() ).get( Timeout.LONG );
