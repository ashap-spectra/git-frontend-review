...
public final class ClearSuspectBlobAzureTargetsRequestHandler extends BaseRequestHandler
{
   public ClearSuspectBlobAzureTargetsRequestHandler()
   {
           ...
           final CommandExecutionParams params )
   {
       ...
       try
       {
           transaction.getService( SuspectBlobAzureTargetService.class ).delete( ids );
