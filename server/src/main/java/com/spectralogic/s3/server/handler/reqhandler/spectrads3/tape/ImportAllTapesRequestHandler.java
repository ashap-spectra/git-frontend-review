...
public final class ImportAllTapesRequestHandler extends BaseImportPersistenceTargetRequestHandler< Tape >
{
    public ImportAllTapesRequestHandler()
    {
        super( Tape.class,
    ...
    {
        params.getTapeResource().importTape( null, directive ).get( Timeout.DEFAULT );
    }
}
