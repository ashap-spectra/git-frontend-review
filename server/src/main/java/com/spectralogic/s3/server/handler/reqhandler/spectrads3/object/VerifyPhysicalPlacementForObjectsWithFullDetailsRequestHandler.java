...
public final class VerifyPhysicalPlacementForObjectsWithFullDetailsRequestHandler 
    extends BaseDaoTypedRequestHandler< Tape >
{
    public VerifyPhysicalPlacementForObjectsWithFullDetailsRequestHandler()
    {
        super( Tape.class,
               ...
               new RestfulCanHandleRequestDeterminer( 
                       RestActionType.SHOW,
                       RestOperationType.VERIFY_PHYSICAL_PLACEMENT, 
