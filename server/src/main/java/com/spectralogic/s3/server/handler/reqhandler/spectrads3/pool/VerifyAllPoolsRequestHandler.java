...
public final class VerifyAllPoolsRequestHandler extends BaseDaoTypedRequestHandler< BlobStoreTaskInformation >
{
    public VerifyAllPoolsRequestHandler()
    {
            ...
            final CommandExecutionParams params )
    {
        ...
        params.getPoolResource().verifyPool( null, priority.getPriority() ).get( Timeout.LONG );
