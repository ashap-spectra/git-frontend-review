...
public final class FormatForeignPoolRequestHandler extends BaseRequestHandler
{
    public FormatForeignPoolRequestHandler()
    {
            ...
            final CommandExecutionParams params )
    {
        ...
        params.getPoolResource().formatPool( pool.getId() ).get( Timeout.LONG );
