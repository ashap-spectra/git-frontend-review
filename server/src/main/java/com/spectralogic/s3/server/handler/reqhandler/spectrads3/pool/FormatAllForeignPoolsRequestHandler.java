...
public final class FormatAllForeignPoolsRequestHandler extends BaseRequestHandler
{
    public FormatAllForeignPoolsRequestHandler()
    {
    ...
    {
        params.getPoolResource().formatPool( null ).get( Timeout.LONG );
