...
public final class CancelVerifyTapeRequestHandler extends BaseRequestHandler
{
    public CancelVerifyTapeRequestHandler()
    {
            ...
            final CommandExecutionParams params )
    {
        ...
        params.getTapeResource().cancelVerifyTape( tape.getId() ).get( Timeout.LONG );
