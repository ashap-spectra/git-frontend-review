...
public final class VerifyTapeRequestHandler extends BaseRequestHandler
{
    public VerifyTapeRequestHandler()
    {
            ...
            final CommandExecutionParams params )
    {
        ...
        params.getTapeResource().verifyTape( tape.getId(), taskPriority ).get( Timeout.LONG );
