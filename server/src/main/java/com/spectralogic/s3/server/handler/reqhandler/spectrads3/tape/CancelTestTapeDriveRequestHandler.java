...
public final class CancelTestTapeDriveRequestHandler extends BaseRequestHandler
{
    public CancelTestTapeDriveRequestHandler()
    {
        super( new DefaultPublicExposureAuthenticationStrategy( RequiredAuthentication.TAPE_ADMIN ),
               new RestfulCanHandleRequestDeterminer(
                       RestOperationType.CANCEL_TEST,
            ...
            final CommandExecutionParams params )
    {
        ...
        params.getTapeResource().cancelTestDrive( drive.getId() ).get( Timeout.LONG );
