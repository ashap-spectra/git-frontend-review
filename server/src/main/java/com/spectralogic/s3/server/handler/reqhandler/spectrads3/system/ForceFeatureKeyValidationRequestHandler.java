...
public final class ForceFeatureKeyValidationRequestHandler extends BaseRequestHandler
{
    public ForceFeatureKeyValidationRequestHandler()
    {
    ...
    {
        params.getPlannerResource().validateFeatureKeysNow().get( Timeout.LONG );
