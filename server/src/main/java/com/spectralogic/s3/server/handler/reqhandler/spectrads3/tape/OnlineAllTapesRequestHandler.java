...
public final class OnlineAllTapesRequestHandler extends BaseRequestHandler
{
    public OnlineAllTapesRequestHandler()
    {
        super( new DefaultPublicExposureAuthenticationStrategy( RequiredAuthentication.TAPE_ADMIN ),
               new RestfulCanHandleRequestDeterminer(
                       RestActionType.BULK_MODIFY,
                       RestOperationType.ONLINE,
                       RestDomainType.TAPE ) );
    }
            ...
            final CommandExecutionParams params )
    {
        final TapeFailuresInformation rpcResponse =
                params.getTapeResource().onlineTape( null ).get( Timeout.LONG );
